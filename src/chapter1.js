...
chapter1.prototype = {
  preload: function() {
    ...
    game.load.tilemap(
      'dug',
      'assets/levels/level1/dug.json',
      null,
      Phaser.Tilemap.TILED_JSON
    )
    game.load.tilemap(
      'map',
      'assets/levels/level1/bottom.json',
      null,
      Phaser.Tilemap.TILED_JSON
    )
    game.load.tilemap(
      'tunnel1',
      'assets/levels/level1/tunnel1.json',
      null,
      Phaser.Tilemap.TILED_JSON
    )
    game.load.tilemap(
      'tunnel2',
      'assets/levels/level1/tunnel2.json',
      null,
      Phaser.Tilemap.TILED_JSON
    )
    game.load.tilemap(
      'top',
      'assets/levels/level1/top.json',
      null,
      Phaser.Tilemap.TILED_JSON
    )
    game.load.tilemap(
      'objects',
      'assets/levels/level1/objects.json',
      null,
      Phaser.Tilemap.TILED_JSON
    )
    ...
    game.load.atlasXML(
      'playerSprite',
      'assets/images/sprites/fox.png',
      'assets/images/sprites/fox.xml'
    )

    //Enemy
    game.load.atlasXML(
      'croc1Sprite',
      'assets/images/sprites/croc1.png',
      'assets/images/sprites/croc1.xml'
    )

    //Checkpoint
    game.load.atlasXML(
      'checkpointSprite',
      'assets/images/sprites/checkpoint.png',
      'assets/images/sprites/checkpoint.xml'
    )
    ...
    //Music
    game.load.audio('gameMusic', [
      'assets/music/chapter1.mp3',
      'assets/music/chapter1.ogg',
    ])

    //SFX
    game.load.audio('checkpointSound', [
      'assets/sfx/checkpoint.mp3',
      'assets/sfx/checkpoint.ogg',
    ])
    game.load.audio('deathSound', [
      'assets/sfx/death.mp3',
      'assets/sfx/death.ogg',
    ])
    game.load.audio('tailWhipSound', [
      'assets/sfx/tailWhip.mp3',
      'assets/sfx/tailWhip.ogg',
    ])
    ...
    game.load.audio('digDelaySound', [
      'assets/sfx/digDelay.mp3',
      'assets/sfx/digDelay.ogg',
    ])
  },
  ...
  update: function() {
    ...
    game.physics.arcade.collide(
      player,
      layerTop,
      playerFunctions.prototype.topLayer
    )
    game.physics.arcade.collide(player, layerTunnel1)
    game.physics.arcade.collide(
      player,
      layerTunnel2,
      playerFunctions.prototype.tunnel1
    )
    game.physics.arcade.collide(
      player,
      layerMaster,
      playerFunctions.prototype.tunnel2
    )
    game.physics.arcade.collide(
      player,
      layerObjects,
      playerFunctions.prototype.objectsLayer
    )
    ...
    game.physics.arcade.overlap(
      player,
      croc1,
      croc1Functions.prototype.killCheck,
      null,
      this
    )
  ...
  render: function() {
    ...
    if (debugShow === true) {
      ...
      game.debug.text(
        'AnimationFrame: ' + player.animations.currentFrame.index,
        32,
        160
      )
      game.debug.text(
        'Animation: ' + player.animations.currentAnim.name,
        32,
        192
      )
