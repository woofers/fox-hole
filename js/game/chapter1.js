...
chapter1.prototype = {
    ...
    update : function(){
        ...
        //Down
        if (downButton.isDown && player.body.blocked.down && !player.isDigging === true && player.layer < 3 && !player.tailWhip === true && playerFunctions.prototype.tileBelow() && keyDebouncing.downPressed === false)
        {
