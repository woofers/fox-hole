...
playerFunctions.prototype = {
  load: function() {
    ...
    player.animations.add(
      'idle',
      Phaser.Animation.generateFrameNames('foxIdle', 0, 15, '', 4),
      10,
      true
    )
    ...
    player.animations.add(
      'walking',
      Phaser.Animation.generateFrameNames('foxRunning', 0, 6, '', 4),
      10,
      true
    )
    ...
    player.animations.add(
      'jumping',
      Phaser.Animation.generateFrameNames('foxRunning', 0, 0, '', 4),
      10,
      true
    )
    ...
    player.animations.add(
      'crawl',
      Phaser.Animation.generateFrameNames('foxCrawl', 0, 3, '', 4),
      10,
      true
    )
    player.animations.add(
      'crawlIdle',
      Phaser.Animation.generateFrameNames('foxCrawl', 0, 0, '', 4),
      10,
      true
    )
    ...
    player.animations.add(
      'dig',
      Phaser.Animation.generateFrameNames('foxDig', 0, 17, '', 4),
      10,
      false
    )
    player.animations.add(
      'digSmall',
      Phaser.Animation.generateFrameNames('foxDigSmall', 0, 24, '', 4),
      13,
      false
    )
    player.animations.add(
      'digUp',
      Phaser.Animation.generateFrameNames('foxDigUp', 0, 6, '', 4),
      10,
      false
    )
    player.animations.add(
      'digUpAbove',
      Phaser.Animation.generateFrameNames('foxDigUpAbove', 0, 11, '', 4),
      10,
      false
    )
    ...
    player.animations.add(
      'tailWhip',
      Phaser.Animation.generateFrameNames('foxTail', 0, 12, '', 4),
      14,
      false
    )
    ...
    player.animations.add(
      'flip',
      Phaser.Animation.generateFrameNames('foxFlip', 0, 9, '', 4),
      8,
      false
    )
  },
  ...
  main: function() {
    ...
    if (
      jumpButton.isDown &&
      player.dig === false &&
      playerFunctions.prototype.controlLock()
    ) {
      //Single Jump
    ...
    if (
      ...
      player.layer < 3 &&
      playerFunctions.prototype.controlLock() &&
      playerFunctions.prototype.tileBelow() &&
    ...
    if (
      jumpButton.isDown &&
      playerFunctions.prototype.controlLock() &&
      playerFunctions.prototype.tileAbove() &&
      keyDebouncing.spacePressed === false &&
      player.layer > 1
    ) {
      keyDebouncing.spacePressed = true
    ...
    //Stop the anmation
    if (
      (player.body.blocked.right && player.tailWhip === false) ||
      (player.body.blocked.left && player.tailWhip === false)
    ) {
    ...
    if (
      player.animations.currentAnim.isFinished === true &&
  ...
  tunnel1: function() {
    ...
    tunnel1.fill(
      51,
      layerTunnel1.getTileX(player.x - player.directX),
      layerTunnel1.getTileY(player.y - 128),
      3,
      1
    )
  },
  ...
  tunnel2: function() {
    ...
    tunnel2.fill(
      51,
      layerTunnel2.getTileX(player.x - player.directX),
      layerTunnel2.getTileY(player.y - 128),
      3,
      1
    )
  },
