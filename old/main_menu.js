...
var game = new Phaser.Game(1368, 768, Phaser.AUTO, 'canvas', { preload: menuPreload, create: menuCreate, update: menuUpdate });
...
function menuPreload() {
    ...
    game.load.spritesheet('menuScreen', 'assets/images/ui/menu.png', 1368, 768, 3);
